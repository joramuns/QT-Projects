...
class TransformationTab final : public QTabWidget {
 ...
 private:
  TransformButtons
      *rotate_buttons_;  ///< указатель на объект вкладки кнопок вращения
  TransformButtons
      *move_buttons_;  ///< укзатель на объект влкадки кнопок перемещения
  ScaleButtons
      *scale_buttons_;  ///< укзатель на объект вкладки кнопок масштабирования
};
}  // namespace s21
