...
private:
  QGridLayout *main_layout_; ///< указатель на объект core "макета"
  GLWidget *gl_widget_; ///< укзатель на объект OpenGl виджета
  QListWidget *list_widget_; ///< указатель на объект листа OpenGL виджетов
};
} // namespace s21
