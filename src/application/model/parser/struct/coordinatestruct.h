...
/// @brief Структура хранящая в себе значения координат точек полигона в трехмерном пространстве
...
/// @brief Структура хранящая в себе значения координат точек текстуры для полигона
